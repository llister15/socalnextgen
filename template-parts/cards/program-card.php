...
<article class="<?php echo esc_attr( $tone_class ); ?> rounded-lg p-7 text-white shadow-card">
	...
	<a class="inline-flex items-center gap-2 rounded border border-white/70 px-4 py-2 font-display text-sm font-bold uppercase text-white no-underline hover:bg-white hover:text-brand-navy" href="<?php echo esc_url( $url ); ?>">
